[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/Atyantik/example-pawjs-tailwind)
...
<h1 align="center" style="text-align:center">ReactPWA - PawJS & Tailwind CSS</h1>
...
```bash
git clone https://github.com/Atyantik/example-pawjs-tailwind.git reactpwa-tailwind && cd reactpwa-tailwind
```
