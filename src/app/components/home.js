  ...
  render() {
    return (
      ...
      Clients
              ...
              <button
                type="button"
                className="appearance-none p-4 xl:text-2xl bg-green-dark text-green-lightest hover:bg-green rounded-lg"
              >
      New Client
              </button>
            </header>
                  ...
                  <div className="flex flex-col p-4">
                    <Link to="/" className="no-underline">
                      ...
                      <div className="border-b border-l border-r border-grey shadow-md rounded-b-lg p-4">
                        <div className="flex">
                          <div className="flex justify-center items-center text-lg border-2 border-pink-light text-pink-light rounded-full w-12 h-12 font-medium">
                            BA
                          </div>
                ...
                <div className="flex-grow sm:w-64 mb-6 sm:mr-6">
                  <div className="flex flex-col p-4">
                    <Link to="/" className="no-underline">
                      ...
                      <div className="border-b border-l border-r border-grey shadow-md rounded-b-lg p-4">
                        <div className="flex">
                          <div className="flex justify-center items-center text-lg border-2 border-purple-light text-purple-light rounded-full w-12 h-12 font-medium">
                            LC
                          </div>
                          <div className="flex flex-col ml-8 mt-1">
                ...
                <div className="flex-grow sm:w-64 mb-6 sm:mr-6">
                  <div className="flex flex-col p-4">
                    <Link to="/" className="no-underline">
                      ...
                      <div className="border-b border-l border-r border-grey shadow-md rounded-b-lg p-4">
                        <div className="flex">
                          <div className="flex justify-center items-center text-lg border-2 border-blue-light text-blue-light rounded-full w-12 h-12 font-medium">
                            TH
                          </div>
                          <div className="flex flex-col ml-8 mt-1">
